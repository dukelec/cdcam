...
#define A32(x) get_unaligned32((u8 *)&(((U16_S *)(x))->v))
#define A16(x) get_unaligned16((u8 *)&(((U16_S *)(x))->v))

#define PUT4(s, d) put_unaligned32(get_unaligned32((const u8 *) s), (u8 *) d)
//#define PUT8(s, d) put_unaligned(get_unaligned((const u64 *) s), (u64 *) d)

#define LZ4_READ_LITTLEENDIAN_16(d, s, p)	\
	(d = s - get_unaligned16(p))

#define LZ4_WRITE_LITTLEENDIAN_16(p, v)			\
	do {						\
		put_unaligned16(v, (u8 *)(p));	\
		p += 2;					\
	} while (0)
