...
#define OV5647_IDI_CLOCK_RATE_1600x1600            (100000000ULL)
#define OV5647_MIPI_CSI_LINE_RATE_1600x1600        (OV5647_IDI_CLOCK_RATE_1600x1600 * 4)
...
static const ov5647_reginfo_t ov5647_input_24M_MIPI_2lane_raw8_1600x1600[] = {
    {0x3034, 0x18},
    {0x3035, 0x41},
    {0x3036, ((OV5647_IDI_CLOCK_RATE_1600x1600 * 8 * 4) / 25000000)},
    {0x303c, 0x11},
    {0x3106, 0xf5},
...
#define HSTA (496) // (2592 - 1600) / 2
#define VSTA (172) // (1944 - 1600) / 2
#define HEND (2095+100) // (HSTA + 1600 - 1 = 2095)
#define VEND (1771+50)  // (VSTA + 1600 - 1 = 1771)
    // h-start
    {0x3800, (HSTA >> 8)},
    {0x3801, (HSTA & 0xff)},
    // v-start
...
// auto AGC mode configuration aec gain
    ...
    {0x4001, 0x02},
    {0x4004, 0x04},
    {0x4837, (1000000000 / (OV5647_IDI_CLOCK_RATE_1600x1600 / 4))},
    {0x4050, 0x6e},
    {0x4051, 0x8f},
    {0x5903, 0xff},
    {OV5647_REG_END, 0x00},
